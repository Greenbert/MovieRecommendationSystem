...
import com.example.moviespdemo.config.loadData.StringUtil;
import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class MovieDat {
	...
	public MovieDat(int id, String name, String year, List<String> type) {
		this.id = id;
		this.name = name;
		this.year = year;
		this.type = type;
	...
	public double relevance(MovieDat m) {
